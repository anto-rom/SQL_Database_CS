...
CREATE TABLE APP_FLOW.CustomerService.resolution_sla ( resolution_sla_id int IDENTITY(1,1) NOT NULL, [Date] date NULL, department_id int NULL, case_number int NULL, agent_id int NULL, case_subreason varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, age int NULL, resolution_sla bit NULL, CONSTRAINT resolution_sla_pkey PRIMARY KEY (resolution_sla_id));
