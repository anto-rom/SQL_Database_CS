...
CREATE TABLE APP_FLOW.CustomerService.ASA_AHT ( [Date] date NULL, department_id int NULL, aba int NULL, total_call_duration int NULL, aht int NULL, agent_id int NULL, interaction_type nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, language_id nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, agent_talk_time int NULL, total_ring_duration int NULL);
...
CREATE TABLE APP_FLOW.CustomerService.SLA_ABA ( [Date] date NULL, department_id int NULL, sla bit NULL, aba bit NULL, agent_id int NULL, end_reason nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, last_state nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, interaction_type nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, language_id nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL);
...
-- APP_FLOW.CustomerService.agent_target definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.agent_target;

CREATE TABLE APP_FLOW.CustomerService.agent_target ( department_id int NOT NULL, seniority varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, min_months int NOT NULL, max_months int NULL, item_target_day decimal(5,2) NOT NULL, CONSTRAINT PK_agent_target PRIMARY KEY (department_id,seniority));


-- APP_FLOW.CustomerService.billables definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.billables;

CREATE TABLE APP_FLOW.CustomerService.billables ( billables_id int IDENTITY(1,1) NOT NULL, [Date] date NOT NULL, department_id int NOT NULL, case_number int NULL, billable_type nvarchar(50) COLLATE Latin1_General_100_CI_AS_SC NULL, account_name nvarchar(255) COLLATE Latin1_General_100_CI_AS_SC NULL, date_opened date NULL, case_reason nvarchar(255) COLLATE Latin1_General_100_CI_AS_SC NULL, subreason nvarchar(255) COLLATE Latin1_General_100_CI_AS_SC NULL, age int NULL, agent_id int NULL, resolution_reason nvarchar(255) COLLATE Latin1_General_100_CI_AS_SC NULL, time_spent int NULL, revenue int NULL, issue varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, PMS_OnPrem_maintenance bit NULL, CONSTRAINT PK_billables PRIMARY KEY (billables_id));
 CREATE NONCLUSTERED INDEX IX_billables_Date_agent ON APP_FLOW.CustomerService.billables (  Date ASC  , agent_id ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX IX_billables_case_number ON APP_FLOW.CustomerService.billables (  case_number ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
ALTER TABLE APP_FLOW.CustomerService.billables WITH NOCHECK ADD CONSTRAINT CK_billables_department_id_4digits CHECK (([department_id]>=(0) AND [department_id]<=(9999)));
...
-- APP_FLOW.CustomerService.inventory definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.inventory;

CREATE TABLE APP_FLOW.CustomerService.inventory ( inventory_id int IDENTITY(1,1) NOT NULL, age_range varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, substatus varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, open_date date NULL, status varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, case_origin varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, department_id int NULL, priority varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, case_number int NULL, [Date] date NULL, CONSTRAINT PK__inventor__B59ACC491A379C8D PRIMARY KEY (inventory_id));
...
-- APP_FLOW.CustomerService.repeat_rca definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.repeat_rca;

CREATE TABLE APP_FLOW.CustomerService.repeat_rca ( repeat_rca_id int IDENTITY(1,1) NOT NULL, [Date] date NULL, agent_id int NULL, [3_repeats] int NULL, repeat_rca varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, case_number int NULL, CONSTRAINT repeat_rca_pkey PRIMARY KEY (repeat_rca_id));


-- APP_FLOW.CustomerService.repeats definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.repeats;

CREATE TABLE APP_FLOW.CustomerService.repeats ( repeats_id int IDENTITY(1,1) NOT NULL, case_number int NULL, agent_id int NULL, department_id int NULL, account_name varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, age int NULL, premium bigint NULL, [language] varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, subreason varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, [Date] date NULL, subject varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, account_country varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, CONSTRAINT repeats_id PRIMARY KEY (repeats_id));


-- APP_FLOW.CustomerService.resolution_sla definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.resolution_sla;

CREATE TABLE APP_FLOW.CustomerService.resolution_sla ( resolution_sla_id int IDENTITY(1,1) NOT NULL, [Date] date NULL, department_id int NULL, case_number int NULL, agent_id int NULL, case_subreason varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, age int NULL, resolution_sla float NULL, closed_Date date NULL, in_sla AS (case when ([department_id]=(16) OR [department_id]=(6) OR [department_id]=(5) OR [department_id]=(23) OR [department_id]=(9) OR [department_id]=(4) OR [department_id]=(8) OR [department_id]=(7) OR [department_id]=(1)) AND [dbo].[fn_WorkingDays]([Date],[closed_Date])<=(3) then (1) when [department_id]=(3) AND [dbo].[fn_WorkingDays]([Date],[closed_Date])<=(4) then (1) when ([department_id]=(28) OR [department_id]=(11) OR [department_id]=(10) OR [department_id]=(15) OR [department_id]=(14) OR [department_id]=(13) OR [department_id]=(12) OR [department_id]=(21) OR [department_id]=(18) OR [department_id]=(2)) AND [dbo].[fn_WorkingDays]([Date],[closed_Date])<=(6) then (1) else (0) end) NOT NULL, CONSTRAINT resolution_sla_pkey PRIMARY KEY (resolution_sla_id));
...
-- APP_FLOW.CustomerService.spam definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.spam;

CREATE TABLE APP_FLOW.CustomerService.spam ( spam_id int IDENTITY(1,1) NOT NULL, [Date] date NULL, department_id int NULL, case_number int NULL, CONSTRAINT PK__spam__8D33759EBA4A4F79 PRIMARY KEY (spam_id));
...
CREATE TABLE APP_FLOW.CustomerService.ticket_sla ( ticket_sla_id int IDENTITY(1,1) NOT NULL, SLA_difference decimal(10,2) NULL, Date_open date NULL, case_number int NULL, department_id int NULL, priority nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, Date_replied date NULL, in_SLA bit NULL, [Date] date NULL, CONSTRAINT PK__ticket_s__3C803FB4F76BE481 PRIMARY KEY (ticket_sla_id));
...
CREATE TABLE APP_FLOW.CustomerService.tl ( tl_id int IDENTITY(1,1) NOT NULL, first_name varchar(45) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, last_name varchar(45) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, department_id int NULL, CONSTRAINT tl_pkey PRIMARY KEY (tl_id));


-- APP_FLOW.CustomerService.vonage_status definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.vonage_status;

CREATE TABLE APP_FLOW.CustomerService.vonage_status ( vonage_status_id bigint IDENTITY(1,1) NOT NULL, [Date] date NOT NULL, agent_id int NOT NULL, department_id int NOT NULL, ready_time int NULL, inbound_call_time int NULL, transfer_time int NULL, outbound_time int NULL, ready_for_outbound int NULL, away int NULL, extended_away int NULL, prayers int NULL, training int NULL, no_answer int NULL, [hold] int NULL, wrap_up int NULL, total_state_time int NULL, in_meeting int NULL, [break] int NULL, comfort_break int NULL, ready_installations int NULL, ready_offline int NULL, team_meeting int NULL, lunch int NULL, total_time AS (((((((((((((((((isnull([ready_time],(0))+isnull([inbound_call_time],(0)))+isnull([transfer_time],(0)))+isnull([outbound_time],(0)))+isnull([ready_for_outbound],(0)))+isnull([ready_offline],(0)))+isnull([no_answer],(0)))+isnull([hold],(0)))+isnull([wrap_up],(0)))+isnull([away],(0)))+isnull([extended_away],(0)))+isnull([prayers],(0)))+isnull([training],(0)))+isnull([in_meeting],(0)))+isnull([break],(0)))+isnull([comfort_break],(0)))+isnull([ready_installations],(0)))+isnull([team_meeting],(0))) PERSISTED, productive AS ((((((((isnull([ready_time],(0))+isnull([inbound_call_time],(0)))+isnull([transfer_time],(0)))+isnull([outbound_time],(0)))+isnull([ready_for_outbound],(0)))+isnull([ready_offline],(0)))+isnull([no_answer],(0)))+isnull([hold],(0)))+isnull([wrap_up],(0))) PERSISTED, non_productive AS ((((((((isnull([away],(0))+isnull([extended_away],(0)))+isnull([prayers],(0)))+isnull([training],(0)))+isnull([in_meeting],(0)))+isnull([break],(0)))+isnull([comfort_break],(0)))+isnull([ready_installations],(0)))+isnull([team_meeting],(0))) PERSISTED, CONSTRAINT PK_vonage_status PRIMARY KEY (vonage_status_id));
 CREATE NONCLUSTERED INDEX IX_vonage_status_Date ON APP_FLOW.CustomerService.vonage_status (  Date ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX IX_vonage_status_agent ON APP_FLOW.CustomerService.vonage_status (  agent_id ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX IX_vonage_status_agent_date ON APP_FLOW.CustomerService.vonage_status (  agent_id ASC  , Date ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX IX_vonage_status_department ON APP_FLOW.CustomerService.vonage_status (  department_id ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;
 CREATE NONCLUSTERED INDEX IX_vonage_status_dept_date ON APP_FLOW.CustomerService.vonage_status (  department_id ASC  , Date ASC  )  
	 WITH (  PAD_INDEX = OFF ,FILLFACTOR = 100  ,SORT_IN_TEMPDB = OFF , IGNORE_DUP_KEY = OFF , STATISTICS_NORECOMPUTE = OFF , ONLINE = OFF , ALLOW_ROW_LOCKS = ON , ALLOW_PAGE_LOCKS = ON  )
	 ON [PRIMARY ] ;


-- APP_FLOW.CustomerService.week_comments definition

-- Drop table

-- DROP TABLE APP_FLOW.CustomerService.week_comments;

CREATE TABLE APP_FLOW.CustomerService.week_comments ( week_comments_id int IDENTITY(1,1) NOT NULL, [Date] date NOT NULL, Week_number int NOT NULL, vertical varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, incoming_comment varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, resolution_comment varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, call_comment varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, VoC_comment varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, TTR varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, repeat_comment varchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, CONSTRAINT PK__week_com__B516FD8ECE838CFE PRIMARY KEY (week_comments_id));
...
CREATE TABLE APP_FLOW.CustomerService.agent ( agent_id int NOT NULL, first_name varchar(45) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, last_name varchar(45) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, tl_id int NOT NULL, department_id int NOT NULL, start_date date NULL, CONSTRAINT PK_agent PRIMARY KEY (agent_id), CONSTRAINT agent_unique UNIQUE (agent_id), CONSTRAINT agent_department_fk FOREIGN KEY (department_id) REFERENCES APP_FLOW.CustomerService.department(department_id), CONSTRAINT agent_tl_fk FOREIGN KEY (tl_id) REFERENCES APP_FLOW.CustomerService.tl(tl_id));
...
CREATE TABLE APP_FLOW.CustomerService.agent_transfer ( agent_transfer_id int IDENTITY(1,1) NOT NULL, [Date] date NOT NULL, agent_id int NOT NULL, case_number int NOT NULL, department_id int NOT NULL, new_department int NOT NULL, [language] varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, CONSTRAINT PK__agent_tr__1B6280868771AF0F PRIMARY KEY (agent_transfer_id), CONSTRAINT agent_transfer_agent_FK FOREIGN KEY (agent_id) REFERENCES APP_FLOW.CustomerService.agent(agent_id));
...
CREATE TABLE APP_FLOW.CustomerService.incoming_tickets ( incoming_tickets_id int IDENTITY(1,1) NOT NULL, department_id int NOT NULL, ticket_total int NULL, [Date] date NULL, agent_id int NULL, case_number int NULL, case_reason varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, [language] varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, CONSTRAINT incoming_tickets_pkey PRIMARY KEY (incoming_tickets_id), CONSTRAINT incoming_tickets_department_fk FOREIGN KEY (department_id) REFERENCES APP_FLOW.CustomerService.department(department_id));
...
transfers_in AS (
    SELECT
        ...
        CAST(NULL AS nvarchar(50))        AS language,       -- no aplica idioma
...
ALTER VIEW [CustomerService].[DAILY_RR]
AS
/*  DAILY_RR_new (versión 7D rolling)
    - Define repeat si un case acumula &gt;=3 touchpoints en la ventana [date-6, date].
    - Marca cada touchpoint del día como repeat si su case está flagged ese día.
*/
WITH base AS (
    /* Normaliza los campos y asegura granularidad por día */
    SELECT
...
case_tp_day AS (
    /* TP diarios por case (1 fila por case y día con actividad) */
    SELECT
        b.[date],
        b.case_number,
        COUNT(*) AS tp_cnt_day
...
roll_7 AS (
    /* Suma de TPs en la ventana móvil de 7 días naturales por case y día */
    SELECT
        d1.[date],
        d1.case_number,
        SUM(d2.tp_cnt_day) AS tp_cnt_7d
    FROM case_tp_day AS d1
    JOIN case_tp_day AS d2
      ON d2.case_number = d1.case_number
     AND d2.[date] BETWEEN DATEADD(DAY, -6, d1.[date]) AND d1.[date]
    GROUP BY d1.[date], d1.case_number
),
flagged_cases AS (
    /* Días/cases que cumplen la condición de repeat (&gt;=3 TPs en últimos 7 días) */
    SELECT
        r7.[date],
        r7.case_number
    FROM roll_7 AS r7
    WHERE r7.tp_cnt_7d >= 3
    ),
daily_rows AS (
    /* Una fila por touchpoint, con flag según el estado del case ese día */
    SELECT
        b.[date],
        b.department_id,
        b.agent_id,
        ...
        b.[account_name],
        b.[account_country],
        CASE WHEN fc.case_number IS NOT NULL THEN 1 ELSE 0 END AS is_repeat_tp
    FROM base AS b
    LEFT JOIN flagged_cases AS fc
           ON fc.case_number = b.case_number
          AND fc.[date]      = b.[date]
)
SELECT
    dr.[date],
    dr.department_id,
    d.department_name,
    /* Identidad de agente solo en el nivel por agente */
    CASE WHEN GROUPING(dr.agent_id) = 1 THEN NULL ELSE dr.agent_id END AS agent_id,
    CASE WHEN GROUPING(dr.agent_id) = 1 THEN NULL ELSE CONCAT(a.first_name, ' ', a.last_name) END AS agent_name,
    /* Valores representativos (solo muestra una muestra por celda) */
    MIN(dr.[language])        AS language_sample,
    MIN(dr.[account_name])    AS account_name_sample,
    MIN(dr.[account_country]) AS country_sample,
    /* Diagnóstico de heterogeneidad dentro del grupo */
    COUNT(DISTINCT dr.[language])     AS languages_distinct_cnt,
    COUNT(DISTINCT dr.[account_name]) AS accounts_distinct_cnt,
    /* Métricas */
    COUNT(*)                AS total_touchpoints,
    SUM(dr.is_repeat_tp)    AS repeat_touchpoints,
    CAST(
        CASE WHEN COUNT(*) = 0 THEN 0
             ELSE (SUM(dr.is_repeat_tp) * 100.0) / COUNT(*)
        END AS DECIMAL(5,2)
    ) AS RR_pct,
    /* Metadato: qué nivel de agregación representa la fila */
    CASE 
        WHEN GROUPING(dr.agent_id) = 0 THEN 'agent'
        WHEN GROUPING(dr.account_country) = 0 THEN 'country'
        ELSE 'department'
    END AS aggregation_level
FROM daily_rows AS dr
LEFT JOIN [APP_FLOW].[CustomerService].[agent]      AS a ON a.agent_id       = dr.agent_id
LEFT JOIN [APP_FLOW].[CustomerService].[department] AS d ON d.department_id   = dr.department_id
GROUP BY GROUPING SETS (
    (dr.[date], dr.department_id, d.department_name, dr.agent_id, a.first_name, a.last_name),   -- por agente
    (dr.[date], dr.department_id, d.department_name),                                           -- por departamento
    (dr.[date], dr.department_id, d.department_name, dr.[account_country])                      -- por país
);
...
SELECT 
    ...
    SUM(CASE WHEN sla.in_SLA = 1 THEN 1 ELSE 0 END) AS num_in_SLA_1,
    SUM(CASE WHEN sla.in_SLA = 0 THEN 1 ELSE 0 END) AS num_in_SLA_0,
    COUNT(sla.in_SLA) AS total_tickets_SLA,
...
WITH sla_agg AS (
    ...
    FROM CustomerService.SLA_ABA AS s
    WHERE s.interaction_type = 'Inbound Call'
    GROUP BY s.[Date], s.agent_id, s.department_id, s.language_id
),
asa_agg AS (
    SELECT
        a.[Date],
...
JOIN CustomerService.[date] d
    ON d.[Date] = s.[Date]
JOIN CustomerService.language la
    ON la.language_id = s.language_id
...
CROSS APPLY (
    SELECT 
        CONCAT(ag.first_name COLLATE Latin1_General_100_CI_AS, ' ', ag.last_name) AS agent_name,
        CONCAT(tl.first_name COLLATE Latin1_General_100_CI_AS, ' ', tl.last_name) AS team_lead_name
) AS agent_data
GROUP BY
    s.[Date],
    la.language_name,
...
-- CustomerService.DAILY_calls_lang source

ALTER VIEW CustomerService.DAILY_calls_lang AS
WITH sla_agg AS (
    SELECT
        s.[Date],
        s.agent_id,
        s.department_id,
        s.language_id,  -- Añadido
        SUM(CASE WHEN s.sla = 1 THEN 1 ELSE 0 END) AS sla_hits,
        SUM(CASE WHEN s.aba = 1 THEN 1 ELSE 0 END) AS aba_hits,
        COUNT(*) AS total_calls
    FROM CustomerService.SLA_ABA AS s
...
asa_agg AS (
    SELECT
        ...
        a.agent_id,
        a.department_id,
        a.language_id,  -- Añadido
        SUM(CAST(a.agent_talk_time AS FLOAT)) AS sum_talk_sec,
        SUM(CAST(a.total_ring_duration AS FLOAT)) AS sum_queue_sec,
        COUNT(*) AS cnt_calls
    FROM CustomerService.ASA_AHT AS a
    WHERE a.[Date] >= '2025-10-01'
    GROUP BY a.[Date], a.agent_id, a.department_id, a.language_id
)
SELECT
    s.[Date] AS call_date,
    d.Week_number,
    ...
    dep.department_name,
    dep.vertical,
    lang.language_name,  -- Nombre completo del idioma
    SUM(s.total_calls) AS inbounds,
    ROUND(100.0 * SUM(s.sla_hits) / NULLIF(SUM(s.total_calls), 0), 2) AS sla_percentage,
    ROUND(100.0 * SUM(s.aba_hits) / NULLIF(SUM(s.total_calls), 0), 2) AS abandoned_percentage,
    ROUND(SUM(COALESCE(a.sum_queue_sec, 0)) / NULLIF(SUM(COALESCE(a.cnt_calls, 0)), 0), 2) AS asa_seconds,
...
LEFT JOIN asa_agg a
 ...
 AND a.agent_id = s.agent_id
 AND a.department_id = s.department_id
 AND a.language_id = s.language_id  -- Coincidencia por idioma
JOIN CustomerService.department dep
  ON dep.department_id = s.department_id
JOIN CustomerService.[date] d
  ON d.[Date] = s.[Date]
...
LEFT JOIN CustomerService.tl tl
  ON tl.tl_id = ag.tl_id
LEFT JOIN CustomerService.language lang
  ON lang.language_id = s.language_id  -- Relación con tabla de idiomas
GROUP BY
    s.[Date],
    d.Week_number,
    a.agent_id,
...
transfers AS (
    SELECT
        ...
        atr.department_id,
        atr.[Date],
        COUNT(DISTINCT atr.case_number) AS total_transfers
    FROM CustomerService.agent_transfer atr
    GROUP BY atr.agent_id, atr.department_id, atr.[Date]
),
outbounds AS (
    SELECT
        o.agent_id,
        o.department_id,
        o.[Date],
        -- Usa DISTINCT si existe riesgo de duplicidad por outbound_id:
        -- COUNT(DISTINCT o.outbound_id) AS total_outbounds
...
SELECT
    ...
    m.[Date],
    CONCAT(
        a.first_name COLLATE DATABASE_DEFAULT, N' ',
        a.last_name  COLLATE DATABASE_DEFAULT
    ) AS agent_name,
    -- Si necesitas forzar collation aquí también (opcional):
    -- dp.department_name COLLATE DATABASE_DEFAULT AS department_name,
    dp.department_name,
    CONCAT(
        tl.first_name COLLATE DATABASE_DEFAULT, N' ',
...
SELECT 
    d2.Month_number,
    YEAR(v.Date) AS Calendar_Year,  -- Año calendario del propio día
    d2.Date,
    d2.Week_number,
    v.case_number,
    a.agent_id,
...
GROUP BY 
    d2.Month_number, 
    YEAR(v.Date),              -- repetir la expresión: no usar alias en GROUP BY
    d2.Date,
    d2.Week_number,
    v.case_number,
    d.vertical,
...
WITH voc_base AS (
    SELECT 
        d2.Date,
        d2.Month_number,
        YEAR(d2.Date) AS Calendar_Year,               -- reemplaza Week_Year por año calendario
        d.team_hierarchy,
        d.department_id,
        d.department_name,
        COUNT(*) AS No_surveys,
    ...
    GROUP BY 
        d2.Date, 
        d2.Month_number, 
        YEAR(d2.Date),                      -- repetir expresión en GROUP BY
        d.team_hierarchy, 
        d.department_id, 
        d.department_name
),
surveys_sent_monthly AS (
    SELECT 
        d.Month_number,
        YEAR(d.Date) AS Calendar_Year,                  -- reemplaza Week_Year por año calendario
        dp.department_id,
        dp.department_name,
    ...
    GROUP BY 
        d.Month_number, 
        YEAR(d.Date),                     -- repetir expresión en GROUP BY
        dp.department_id, 
        dp.department_name
)
SELECT 
    vb.Date,
    vb.Month_number,
    vb.Calendar_Year,                                     -- usar Calendar_Year
    vb.team_hierarchy,
    vb.department_id,
    vb.department_name,
    vb.No_surveys,
...
LEFT JOIN surveys_sent_monthly ssm 
    ...
    AND ssm.Calendar_Year = vb.Calendar_Year 
    AND ssm.department_id = vb.department_id;


-- CustomerService.MONTHLY_VoC_SUMMARY2 source

ALTER VIEW CustomerService.MONTHLY_VoC_SUMMARY2 AS
WITH voc_base AS (
    SELECT 
        YEAR(d2.Date) AS Year,               -- Año calendario
        d2.Month_number,
        d.team_hierarchy,
        d.department_id,
        d.department_name,
        ...
        COUNT(v.CSAT_Product) AS product_total
    FROM CustomerService.VoC v
    JOIN CustomerService.department d 
        ON d.department_name = v.department_name
    JOIN CustomerService.date d2 
        ON d2.Date = v.Date
    GROUP BY 
        YEAR(d2.Date),
        d2.Month_number,
...
surveys_sent_monthly AS (
    SELECT 
        YEAR(d.Date) AS Year,                 -- Año calendario
        d.Month_number,
        dp.department_id,
        dp.department_name,
        COUNT(*) AS surveys_sent_total
...
LEFT JOIN surveys_sent_monthly ssm 
    ON ssm.Year = vb.Year
   AND ssm.Month_number = vb.Month_number
   AND ssm.department_id = vb.department_id;
...
-- CustomerService.Repeat_RCA_view source

ALTER VIEW CustomerService.Repeat_RCA_view AS
SELECT 
    r.repeat_rca_id,
    r.Date,
    r.agent_id,
    ...
    r.case_number,
    a.department_id
FROM CustomerService.repeat_rca AS r
INNER JOIN CustomerService.agent AS a
    ON r.agent_id = a.agent_id
INNER JOIN CustomerService.department AS d
...
-- CustomerService.WEEKLY_resolution_sla source

-- CustomerService.WEEKLY_resolution_sla source

-- CustomerService.WEEKLY_resolution_sla source

ALTER VIEW CustomerService.WEEKLY_resolution_sla AS
SELECT 
    r.resolution_sla_id,
    r.Date as open_date,
    r.closed_Date as closed_date,
    dt.Week_number,
    r.department_id,
    d.department_name,
    r.case_number,
    ...
    r.resolution_sla,
    r.in_sla
FROM CustomerService.resolution_sla AS r
LEFT JOIN CustomerService.department AS d
    ON r.department_id = d.department_id
LEFT JOIN CustomerService.agent AS a
    ON r.agent_id = a.agent_id
LEFT JOIN CustomerService.date AS dt
    ON r.Date = dt.Date;


-- CustomerService.agent_item_target source

-- CustomerService.agent_item_target source

ALTER   VIEW CustomerService.agent_item_target
AS
SELECT
    a.agent_id,
    CONCAT(a.first_name, ' ', a.last_name) AS agent_name,
    ...
    a.tl_id,
    a.start_date,
    -- meses en el rol (puede ser NULL o 0)
    CustomerService.months_in_role(a.start_date) AS months_in_role,
    -- banda asignada (conforme a límites propuestos: 1-3, 4-6, 7-12, >=13)
    CASE
        WHEN CustomerService.months_in_role(a.start_date) IS NULL THEN NULL
        WHEN CustomerService.months_in_role(a.start_date) BETWEEN 1 AND 3  THEN 'BEGINNER'
        WHEN CustomerService.months_in_role(a.start_date) BETWEEN 4 AND 6  THEN 'NEW AGENT'
        WHEN CustomerService.months_in_role(a.start_date) BETWEEN 7 AND 12 THEN 'JUNIOR'
        WHEN CustomerService.months_in_role(a.start_date) >= 13           THEN 'SENIOR'
        ELSE NULL
    END AS seniority_band,
    -- target por día según departamento + banda
    r.item_target_day AS item_target
FROM CustomerService.agent AS a
LEFT JOIN CustomerService.agent_target AS r
    ON r.department_id = a.department_id
   AND (
        (r.min_months IS NOT NULL AND r.max_months IS NOT NULL AND CustomerService.months_in_role(a.start_date) BETWEEN r.min_months AND r.max_months)
        OR (r.max_months IS NULL AND CustomerService.months_in_role(a.start_date) >= r.min_months)
   );
...
WITH shrinkage_daily AS (
    SELECT agent_id, CAST([Date] AS DATE) AS work_date, SUM(shrinkage_time) AS shrinkage_time
    FROM CustomerService.shrinkage
    GROUP BY agent_id, CAST([Date] AS DATE)
),
base_items AS (
    SELECT ap.agent_id, CAST(ap.[Date] AS DATE) AS work_date, ap.case_number, ap.age
    FROM CustomerService.agent_productivity AS ap
    UNION ALL
    SELECT at.agent_id, CAST(at.[Date] AS DATE) AS work_date, at.case_number, NULL AS age
    FROM CustomerService.agent_transfer AS at
),
productivity_daily AS (
    SELECT agent_id, work_date, COUNT(*) AS productivity_total, MAX(age) AS age
    FROM base_items
    GROUP BY agent_id, work_date
),
shifts_daily AS (
    SELECT agent_id, CAST([Date] AS DATE) AS work_date, MAX(shift_time) AS shift_time
    FROM CustomerService.shifts
    GROUP BY agent_id, CAST([Date] AS DATE)
),
cal_days AS (
    SELECT COALESCE(s.agent_id, pd.agent_id) AS agent_id,
           COALESCE(s.work_date, pd.work_date) AS work_date,
           s.shift_time,
           pd.productivity_total,
           pd.age
    FROM shifts_daily AS s
    FULL OUTER JOIN productivity_daily AS pd
      ON s.agent_id = pd.agent_id
     AND s.work_date = pd.work_date
)

SELECT
    cd.work_date AS work_date,
    ...
    /* NUEVO TARGET DIARIO */
    COALESCE(tgt.item_target_day, 0) AS daily_target,

    cd.shift_time AS shift_time,
    COALESCE(sd.shrinkage_time, 0) AS shrinkage_time,

    CASE WHEN COALESCE(cd.shift_time, 0) - COALESCE(sd.shrinkage_time, 0) < 0
         THEN 0
         ELSE COALESCE(cd.shift_time, 0) - COALESCE(sd.shrinkage_time, 0)
    END AS effective_time,

    cd.productivity_total AS productivity_total,

    /* NUEVO adjusted_target basado en tgt.item_target_day */
    CASE WHEN COALESCE(cd.shift_time, 0) - COALESCE(sd.shrinkage_time, 0) <= 0
         THEN 0
         ELSE ROUND(
                tgt.item_target_day * 1.0 *
                (COALESCE(cd.shift_time, 0) - COALESCE(sd.shrinkage_time, 0))
                / NULLIF(cd.shift_time, 0)
              , 2)
...
FROM cal_days AS cd
INNER JOIN CustomerService.agent AS a
    ON a.agent_id = cd.agent_id
LEFT JOIN shrinkage_daily AS sd
    ON sd.agent_id = cd.agent_id
   AND sd.work_date = cd.work_date
LEFT JOIN CustomerService.[date] AS d
    ON d.[Date] = cd.work_date

/* ------------------------------------------------------------------
   NUEVO: calcular months_of_service y obtener el target por departamento
   ------------------------------------------------------------------ */
OUTER APPLY (
    SELECT
        CASE WHEN a.start_date IS NOT NULL
             THEN DATEDIFF(MONTH, a.start_date, cd.work_date)
             ELSE 0
...
OUTER APPLY (
    SELECT TOP (1)
           t.item_target_day
    FROM CustomerService.agent_target AS t
    WHERE t.department_id = a.department_id
      AND ms.months_of_service >= t.min_months
      AND ms.months_of_service <= t.max_months
    ORDER BY t.min_months DESC, t.max_months ASC
) AS tgt

WHERE a.department_id = '1';


-- CustomerService.agent_productivity_new_daily source

-- CustomerService.agent_productivity_new_daily source
-- CustomerService.agent_productivity_new_daily (unified model Vonage / no-Vonage)
ALTER VIEW CustomerService.agent_productivity_new_daily
AS
/*
 View: CustomerService.agent_productivity_new_daily
 Notes:
 - Daily target does NOT come from CustomerService.agent, but from CustomerService.agent_target
   applying rules by department_id + range of months_of_service (min/max).
 - If hire_date is absent, months_of_service=0 as a fallback.
 - Use wide DECIMAL to avoid overflow (Error 8115).
 - outbound_total from CustomerService.outbounds with COUNT(DISTINCT outbound_id).
 - achieved_pct returns ratio in [0,1] (NOT multiplied by 100).
 - Transferred cases DO count towards productivity in both models.
*/
WITH keys AS (
  /* Distinct (Date, agent_id) across facts. Normalize to DATE. */
  SELECT CAST(vs.[Date] AS date) AS [Date], vs.agent_id
  FROM CustomerService.vonage_status AS vs
  UNION
  SELECT CAST(ap.[Date] AS date) AS [Date], ap.agent_id
  FROM CustomerService.agent_productivity AS ap
  UNION
  SELECT CAST(atf.[Date] AS date) AS [Date], atf.agent_id
  FROM CustomerService.agent_transfer AS atf
),
vonage AS (
  /* Vonage metrics aggregated by agent/day. */
  SELECT
...
resolved AS (
  /* Cases resolved by agent/day. */
  SELECT
    CAST(ap.[Date] AS date) AS [Date],
    ap.agent_id,
    COUNT(*) AS resolved_total
  FROM CustomerService.agent_productivity AS ap
  GROUP BY CAST(ap.[Date] AS date), ap.agent_id
),
transferred AS (
  /* Cases transferred by agent/day. */
  SELECT
    CAST(atf.[Date] AS date) AS [Date],
    atf.agent_id,
    COUNT(*) AS transfer_total
  FROM CustomerService.agent_transfer AS atf
  GROUP BY CAST(atf.[Date] AS date), atf.agent_id
),
outbounds AS (
  /* Outbound actions per agent/day using DISTINCTCOUNT(outbound_id). */
  SELECT
    CAST(ob.[Date] AS date) AS [Date],
    ob.agent_id,
    COUNT(DISTINCT ob.outbound_id) AS outbound_total
  FROM CustomerService.outbounds AS ob
  GROUP BY CAST(ob.[Date] AS date), ob.agent_id
)
SELECT
  d.[Date] AS [Date],
  /* Agent keys and name */
  a.agent_id AS agent_id,
  CONCAT(a.first_name, ' ', a.last_name) AS agent_name,
  /* Department keys and name (via agent.department_id) */
  dep.department_id AS department_id,
  dep.department_name AS department_name,
  /* Agent daily target (from agent_target by dept + months_of_service) */
  ...
  /* Outbounds total (existing column) */
  COALESCE(ob.outbound_total, 0) AS outbound_total,
  /* Flag: departments that do NOT use Vonage */
  CASE
    WHEN dep.department_id IN (2,3,12,13,14,15,16,18,21) THEN 1
    ELSE 0
  END AS is_non_vonage_dept,
  /* ratio_productive = productive / total_time (NULL si total_time = 0) */
  r.ratio_productive,
  /* Model target (adjusted for Vonage; fixed for non-Vonage) */
  at.adjusted_target_calc AS target_model,

  /* ************** CHANGED BLOCK STARTS HERE **************
     Model productivity: now ALWAYS counts resolved + transferred,
     regardless of Vonage or time logs (per user request).
  */
  CAST(
  ...
  /* % of target achievement (ratio 0–1; can exceed 1 if overachieved) */
  ca.achieved_pct
FROM keys k
JOIN CustomerService.[date] AS d ON CAST(d.[Date] AS date) = k.[Date]
JOIN CustomerService.agent AS a ON a.agent_id = k.agent_id
LEFT JOIN CustomerService.department AS dep ON dep.department_id = a.department_id
LEFT JOIN vonage AS vg ON vg.[Date] = k.[Date] AND vg.agent_id = k.agent_id
LEFT JOIN resolved AS rs ON rs.[Date] = k.[Date] AND rs.agent_id = k.agent_id
LEFT JOIN transferred AS tf ON tf.[Date] = k.[Date] AND tf.agent_id = k.agent_id
LEFT JOIN outbounds AS ob ON ob.[Date] = k.[Date] AND ob.agent_id = k.agent_id
/* --------------------------------------------------------------------------------
 OUTER APPLY: calculate months_of_service y elegir target aplicable
-------------------------------------------------------------------------------- */
OUTER APPLY (
  SELECT
    /* If hire_date is missing, defaults to 0 months to take base range */
    CASE
...
OUTER APPLY (
  /* Selects the target whose range [min_months, max_months] covers months_of_service
     and matches the agent's department_id. If multiple rows exist, takes the most specific
     (e.g., the one with the highest min_months).. */
  SELECT TOP (1)
    t.item_target_day
  FROM CustomerService.agent_target AS t
...
/* Controlled arithmetic: DECIMAL types and safe division with NULLIF */
CROSS APPLY (
  SELECT
    CASE
      WHEN COALESCE(vg.total_time, 0) > 0
      THEN CAST(COALESCE(vg.productive, 0) AS DECIMAL(19,4))
...
CROSS APPLY (
  SELECT
    /* target_model: fixed for non-Vonage, adjusted by ratio for Vonage */
    CAST(
      CASE
        WHEN dep.department_id IN (2,3,12,13,14,15,16,18,21) THEN
          CAST(COALESCE(tgt.item_target_day, 0) AS DECIMAL(19,4))
        ELSE
          CASE
            WHEN r.ratio_productive IS NOT NULL THEN
              CAST(COALESCE(tgt.item_target_day, 0) AS DECIMAL(19,4)) * r.ratio_productive
            ELSE NULL
          END
      END
      AS DECIMAL(19,4)
    ) AS adjusted_target_calc
) AS at
CROSS APPLY (
  SELECT
    CAST(
      CASE
        /* Quality rule: if Vonage and productive < 7200s, return NULL */
        WHEN dep.department_id NOT IN (2,3,12,13,14,15,16,18,21)
             AND COALESCE(vg.productive, 0) < 7200
        THEN NULL

        /* Existing standard rule */
        WHEN at.adjusted_target_calc IS NOT NULL
             AND at.adjusted_target_calc > CAST(0 AS DECIMAL(19,4))
        THEN (
          CASE
            WHEN dep.department_id IN (2,3,12,13,14,15,16,18,21) THEN
              CAST(COALESCE(rs.resolved_total, 0) + COALESCE(tf.transfer_total, 0) AS DECIMAL(19,4))
            ELSE
              CASE
                WHEN COALESCE(vg.total_time, 0) > 0 THEN
                  CAST(COALESCE(rs.resolved_total, 0) + COALESCE(tf.transfer_total, 0) AS DECIMAL(19,4))
                ELSE
...
-- CustomerService.agent_seniority source

ALTER VIEW CustomerService.agent_seniority
AS
WITH agents AS (
    SELECT
        a.agent_id,
        ...
        CASE 
            ...
            ELSE DATEDIFF(MONTH, a.start_date, CAST(GETDATE() AS date))
        END AS months_tenure
    FROM CustomerService.agent AS a
),
ranges AS (
    SELECT
...
SELECT
    ...
    ag.start_date,
    ag.months_tenure,
    r.seniority        AS seniority_assigned,
    r.item_target_day,
    CASE
        WHEN ag.start_date IS NULL THEN 'NO_START_DATE'
        WHEN r.seniority IS NULL AND d.department_id IS NULL THEN 'NO_DEPARTMENT'
        WHEN r.seniority IS NULL AND d.department_id IS NOT NULL THEN 'NO_RANGE_FOR_DEPARTMENT'
        WHEN ag.months_tenure < r.min_months OR ag.months_tenure > r.max_months THEN 'OUT_OF_DEFINED_RANGE'
        ELSE 'OK'
...
LEFT JOIN ranges AS r
    ON r.department_id = ag.department_id
   AND ag.months_tenure BETWEEN r.min_months AND r.max_months;
...
-- CustomerService.repeat_touchpoints source
...
ALTER VIEW CustomerService.repeat_touchpoints
AS
WITH base AS (
    SELECT
        r.[Date],
        ...
        r.subject,
        r.subreason,
        -- Conteo de touchpoints por caso (todas las filas con el mismo case_number)
        COUNT(*) OVER (PARTITION BY r.case_number) AS no_touchpoints
    FROM CustomerService.repeats AS r
)
SELECT
    b.[Date],
    b.case_number,
    ...
    b.no_touchpoints,
    CASE 
        WHEN b.no_touchpoints >= 3 THEN b.no_touchpoints
        ELSE 0
    END AS no_touchpoints_ge_3,
    b.subject,
    b.subreason
FROM base AS b
LEFT JOIN CustomerService.[department] AS d
...
-- CustomerService.target_monthly source

ALTER VIEW CustomerService.[target_monthly] AS
SELECT
    YEAR(v.work_date) AS [Year],
    DATENAME(MONTH, v.work_date) AS MonthName,                       -- nombre del mes según idioma de sesión
    MONTH(v.work_date) AS Month_number,
    DATEFROMPARTS(YEAR(v.work_date), MONTH(v.work_date), 1) AS MonthStartDate,  -- primer día del mes
    (YEAR(v.work_date) * 100 + MONTH(v.work_date)) AS YearMonthKey,  -- YYYYMM 
    v.agent_id,
    v.department_id,
    v.agent_name,
    AVG(v.daily_target) AS daily_target,
    SUM(v.shift_time) AS shift_time,
    SUM(v.shrinkage_time) AS shrinkage_time,
    SUM(v.effective_time) AS effective_time,
    SUM(v.productivity_total) AS productivity_total,
    AVG(CASE WHEN v.effective_time > 0 THEN v.adjusted_target END) AS adjusted_target,
    AVG(CASE WHEN v.adjusted_target > 0 THEN v.target_achievement_pct END) AS target_achievement_pct,
    AVG(CASE WHEN v.effective_time > 0 THEN v.age END) AS age,
    CASE 
        WHEN COUNT(CASE WHEN v.effective_time > 0 THEN 1 END) = 0 
             THEN NULL
        ELSE 
            SUM(v.productivity_total) * 1.0 
            / COUNT(CASE WHEN v.effective_time > 0 THEN 1 END)
    END AS avg_per_day
FROM CustomerService.agent_productivity_daily_check AS v
GROUP BY
    YEAR(v.work_date),
    DATENAME(MONTH, v.work_date),
    MONTH(v.work_date),
    DATEFROMPARTS(YEAR(v.work_date), MONTH(v.work_date), 1),
       (YEAR(v.work_date) * 100 + MONTH(v.work_date)),
    v.agent_id,
    v.agent_name,
    v.department_id;
